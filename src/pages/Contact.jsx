...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        "service_mv39r1w", // replace with your EmailJS service ID
        "template_125jfe7", // replace with your EmailJS template ID
        form.current,
        "H4Gx795N7RKUlqbSj" // replace with your EmailJS public key
      )
      .then(
        () => {
